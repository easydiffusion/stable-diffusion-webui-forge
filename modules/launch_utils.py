...
def prepare_environment():
    ...
    huggingface_guess_repo = os.environ.get('HUGGINGFACE_GUESS_REPO', 'https://github.com/easydiffusion/huggingface_guess.git')
    ...
    huggingface_guess_commit_hash = os.environ.get('HUGGINGFACE_GUESS_HASH', "4c06cb48edf507c94a23372f5cf1f9f1c04da14c")
